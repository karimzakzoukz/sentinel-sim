...
# Accept both the correct and misspelled names to avoid startup failure.
_DATABASE_URL = os.getenv("DATABASE_URL")
if not _DATABASE_URL:
    _DATABASE_URL = os.getenv("DATABASE_URLL")
DATABASE_URL = _DATABASE_URL or "sqlite:///./sentinel-sim.db"
