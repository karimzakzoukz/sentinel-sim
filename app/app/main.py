...
# On `bug/crashloop-typo` branch, this env var name was misspelled → app crashes.
# Accept both the correct and misspelled names for robustness.
DATABASE_URL = os.environ.get("DATABASE_URL") or os.environ.get("DATABASE_URLL", "sqlite:///./sentinel-sim.db")
